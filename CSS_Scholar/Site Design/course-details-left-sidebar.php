						...
						<div class="col-sm-12">
							<div class="courses-price">
								...
								<div class="price-text">
									<span class="dolar-sign">$</span><span>125</span>
									<p>One Time Payment</p>
									<div class="price-btn-box">
										<a href="#" class="price-btn">Buy This Course</a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="courses-features">
								...
								<div class="features-text">
									<ul class="list-unstyled">
										<li><span><i class="fa fa-clipboard"></i>Lessons</span><span>20</span></li>
										<li><span><i class="fa fa-eye"></i>Viewers</span><span>350</span></li>
										<li><span><i class="fa fa-clock-o"></i>Duration</span><span>3 hours</span></li>
										<li><span><i class="fa fa-lock"></i>Prequisite</span><span>no</span></li>
										<li><span><i class="fa fa-newspaper-o"></i>Certificate</span><span>yes</span></li>
										<li><span><i class="fa fa-language"></i>Language</span><span>english</span></li>
										<li><span><i class="fa fa-thumbs-up"></i>Skill</span><span>amy level</span></li>
										<li><span><i class="fa fa-check-square"></i>Assessment</span><span>self</span></li>
									</ul>
								</div>
							</div>
						</div>
			...
			<div class="col-sm-8 sidebar-left">
				<div class="single-curses-contert">
					...
					<div class="review-option">
						<div class="row">
							<div class="col-sm-3 teacher-info border-left review-item-singel">
								<img src="images/index/teachar-s-01.jpg" alt="" class="img-circle">
								<div class="teacher-name">
									<span>Teacher</span><span>DAVID MARTIN</span>
								</div>
							</div>

							<div class="col-sm-3 review-rank border-left review-item-singel">
								<span>Reviews</span>
					...
					<div class="details-img-bxo">
						<img src="images/Single_cources/curses-details.jpg" alt="" class="img-responsive">
					</div>
					    ...
					    <div class="single-courses">
							...
							<div class="courses-content-box">
								<div class="courses-content">
									...
									<ul class="list-unstyled">
										<li><img src="images/index/teachar-s-06.jpg" alt="" class="img-circle"></li>
							...
							<div class="courses-content-box">
								<div class="courses-content">
									...
									<ul class="list-unstyled">
										...
										<li>By: <span>Jhonthan Smith</span></li>
									</ul>
								</div>
								<div class="rank-icons">
									<ul class="list-unstyled">
