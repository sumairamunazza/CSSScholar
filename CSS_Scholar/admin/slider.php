...
?>
        <script>
            ...
            window.location.href='slider.php?success';
            </script>
<?php
    }
    else
                        ...
                        <table class="table table-hover">
                                        ...
                                        ?>      
                                                    <tr>
                                                        ...
                                                        <td><a href="update_slider.php?id=<?php echo $row['id']; ?>"><img src="../images/edit.png" style="width:30px; height:30px;"></a>
                         
                                                        <td><a href="delete_slider.php?id=<?php echo $row['id']; ?>" 
