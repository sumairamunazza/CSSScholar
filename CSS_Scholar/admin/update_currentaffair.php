<?php
    ...
    if (isset($_POST['BtnUpdate']))
    {
        ...
        $query = "UPDATE books_currentaffairs  SET title = '$BookName', author = '$AuthorName'  WHERE  id = '$id'";
...
<?php
    ...
    else
    {
        ...
        <script type="text/javascript">alert('not updated');
         window.location.href='book_currentaffairs.php?success';
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                               ...
                               <!--  <center>
                                    ...
                                    $Query = "SELECT  title, author FROM books_currentaffairs WHERE id = ".$id;
                                ...
                                ?>
                                        <form action="#" method="post" enctype="multipart/form-data">
                                            ...
                                            <input type="text" name="TxtBookName" parsley-trigger="change" required
                                                   placeholder="Enter book name" class="form-control" id="userName" value="<?php echo $row['title'];?>">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="TxtAuthorName" parsley-trigger="change" required
                                                   placeholder="Enter author name" class="form-control" id="userName" value="<?php echo $row['author'];?>">
                                        </div>
