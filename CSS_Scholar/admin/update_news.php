<?php
    ...
    if (isset($_POST['BtnUpdate']))
    {
        ...
        $query = "UPDATE news  SET  day = '$Day', month = '$Month', title = '$Title', description = '$Description', imagelocation ='$location'  WHERE  id = '$id'";
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                               ...
                               <!--  <center>
                                    ...
                                    $Query = "SELECT day, month, title, description, imagelocation  FROM news WHERE id = ".$id;
