 ...
 if(isset($_REQUEST['BtnSubmit']))
{
   ...
   $Query = "INSERT INTO books_english ".
                   "(title,author) "."VALUES ".
                   "('$BookName','$AuthorName')";
                ...
                <div class="content">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card-box">
                                <center>
                                    <h4 class="header-title m-t-0">Book English</h4>
                                    </center>
                                    <div class="container">
                                        <form action="#">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="TxtBookName" parsley-trigger="change" required
                                                 placeholder="Book Name" class="form-control" id="userName">
                                             </div>
                                                <div class="form-group">
                                                    ...
                                                    placeholder="Author Name" class="form-control" id="userName">
                                                </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <table class="table table-hover">
                                                ...
                                                <tbody>
                                        <?php
                                            $query = "SELECT * FROM books_english";
                                        ...
                                        ?>      
                                                    <tr>
                                                        ...
                                                        <td><a href="update_english.php?id=<?php echo $row['id']; ?>"><img src="../images/edit.png" style="width:30px; height:30px;"></a>
                         
                                                        <td><a href="delete_english.php?id=<?php echo $row['id']; ?>" 
