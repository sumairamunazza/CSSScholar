 ...
 if(isset($_REQUEST['BtnSubmit']))
{
   ...
   $Query = "INSERT INTO books_islamiat ".
                   "(title,author) "."VALUES ".
                   "('$BookName','$AuthorName')";
...
?>
        <script>
            ...
            window.location.href='book_islamiat.php?success';
            </script>
<?php
    }
    else
                ...
                <div class="content">
                        ...
                        <div class="row">
                         <div class="col-lg-2"> 
                            ...
                            <div class="col-lg-12">
                                <div class="card-box">
                                <center>
                                    <h4 class="header-title m-t-0"> Islamiat</h4>
                                    </center>
                    ...
                    <div class="container-fluid">
                        ...
                        <table class="table table-hover">
                                                ...
                                                <tbody>
                                        <?php
                                            $query = "SELECT * FROM books_islamiat";
                                        ...
                                        ?>      
                                                    <tr>
                                                        ...
                                                        <td><a href="update_islamiat.php?id=<?php echo $row['id']; ?>"><img src="../images/edit.png" style="width:30px; height:30px;"></a>
                         
                                                        <td><a href="delete_islamiat.php?id=<?php echo $row['id']; ?>" 
