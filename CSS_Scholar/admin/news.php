...
<?php
     if(isset($_REQUEST['BtnSubmit']))
    {
        ...
        $Query = "INSERT INTO news ".
                   "(Day,month,title,description, imagelocation) "."VALUES ".
                   "('$Day','$Month','$Title','$Description', '$location')";
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card-box">
                                <center>
                                    <h4 class="header-title m-t-0">Latest News</h4>
                                    </center>
                                    <div class="container">
                        ...
                        <table class="table table-hover">
                                        ...
                                        ?>      
                                                    <tr>
                                                        ...
                                                        <td><a href="update_news.php?id=<?php echo $row['id']; ?>"><img src="../images/edit.png" style="width:30px; height:30px;"></a>
                         
                                                        <td><a href="delete_news.php?id=<?php echo $row['id']; ?>" 
