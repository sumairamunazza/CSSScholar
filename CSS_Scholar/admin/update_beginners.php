<?php
    ...
    if (isset($_POST['BtnUpdate']))
    {
        ...
        $query = "UPDATE beginners_guide SET title = '$title',description = '$description',imagelocation = '$location'  WHERE id = '$id'";
...
?>
        <script>
            ...
            window.location.href='beginner_guide.php?success';
        </script>
<?php
    }
    else
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    $Query = "SELECT id, title, description, imagelocation 
                                              FROM beginners_guide WHERE id = ".$id;
                                        ...
                                        <form action="#" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group text-right m-b-0">
                                                    <button class="btn btn-light waves-effect m-l-5" type="submit" name="BtnUpdate" value="<?php echo($_REQUEST['id']);?>">
                                                     Update
                                                    </button>
