...
<?php
     if(isset($_REQUEST['BtnSubmit']))
    {
        ...
        $Query = "INSERT INTO beginners_guide ".
                 ...
                 <div class="content">
                    <div class="container-fluid">
                        ...
                        <table class="table table-hover">
                                                ...
                                                <tbody>
                                        <?php
                                            $query = "SELECT * FROM beginners_guide";
                                        ...
                                        ?>      
                                                    <tr>
                                                        ...
                                                        <td><a href="update_beginners.php?id=<?php echo $row['id']; ?>"><img src="../images/edit.png" style="width:30px; height:30px;"></a>
                         
                                                        <td><a href="delete_beginners.php?id=<?php echo $row['id']; ?>" 
