...
<?php
     if(isset($_REQUEST['BtnSubmit']))
    {
        ...
        $Query = "INSERT INTO subject ".
                   "(marks,paperduration,name,description, imagelocation) "."VALUES ".
                   "('$Marks','$Duration','$Subject','$Description', '$location')";
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card-box">
                                <center>
                                    <h4 class="header-title m-t-0">Add Courses</h4>
                                    </center>
                                    <div class="container">
                                        <form action="#" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    placeholder="Paper Duration" class="form-control" id="userName">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    placeholder="Subject Name" class="form-control" id="userName">
                                                </div>
                        ...
                        <table class="table table-hover">
                                        ...
                                        ?>      
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['paperduration']; ?></td>
                                                        <td><?php echo $row['name']; ?></td>
                                                        <td><?php echo $row['description']; ?></td>
                                                        <td><img src="<?php echo $row['imagelocation']; ?>" width = "50" height = "50"></td>
                                                        <td><a href="update_course.php?id=<?php echo $row['id']; ?>"><img src="../images/edit.png" style="width:30px; height:30px;"></a>
                         
                                                        <td><a href="delete_course.php?id=<?php echo $row['id']; ?>" 
