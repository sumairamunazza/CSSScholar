...
?>
        <script>
            ...
            window.location.href='book_essay.php?success';
            </script>
<?php
    }
    else
                        ...
                        <div class="row">
                         <div class="col-lg-2"> 
                            ...
                            <div class="col-lg-12">
                                <div class="card-box">
                                <center>
                                    <h4 class="header-title m-t-0">Book Essay</h4>
                                    </center>
                        ...
                        <table class="table table-hover">
                                        ...
                                        ?>      
                                                    <tr>
                                                        ...
                                                        <td><a href="update_essay.php?id=<?php echo $row['id']; ?>"><img src="../images/edit.png" style="width:30px; height:30px;"></a>
                         
                                                        <td><a href="delete_essay.php?id=<?php echo $row['id']; ?>" 
